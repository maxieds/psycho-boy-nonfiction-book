...
public final class jar extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "error.bad.option", "One of options -{ctxuid} or --validate must be specified." },
            ...
            { "error.date.notvalid", "date {0} is not a valid ISO-8601 extended offset date-time with optional time-zone" },
            { "error.date.out.of.range", "date {0} is not within the valid range 1980-01-01T00:00:02Z to 2099-12-31T23:59:59Z" },
            ...
            { "main.help.opt.create.update.index.date", "      --date=TIMESTAMP       The timestamp in ISO-8601 extended offset date-time with\n                             optional time-zone format, to use for the timestamps of\n                             entries, e.g. \"2022-02-12T12:30:00-05:00\"" },
            ...
            { "main.help.opt.extract", " Operation modifiers valid only in extract mode:\n" },
