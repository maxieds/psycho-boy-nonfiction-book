...
{
    return _e319ade855d6fde34a28ecc2a2266f86d6d99b5e413e08b4884629844476c571 + _83b4492da25346ffc6c1820a633ef533874dda8e2939056928ffd92384775e38 + _a3104b8f0a1ab0931761cf851c8ac5ce3212eff30deff24a1f9a5ef67453adca + _bd9f890bd3bdbe08af5851fb3dfa228a36a5e54b72c7d74d5985af75bafa6217 + _521c367658cc5996fb6c3e7879813758e35bc4890881a1ed4eb94fdecd6bbeed + 
           _642bf1dee45cc71f38af22fac8ee368ac13209916761726649cc7889088f6d27 + _9df97985dfd301ccd0500b77936ce843e40674f5508e63083a5457d3ccd32294 + _d807979e1a08fe7895e9b395c35d0dd96a7c97336f7500d05ce397d1424c303b + _1bd089f2bc6d2176ac474f2ae9752bd46e81fa2ab2e4461034dd0e1c997752b3 + _4649ab57756c3bc013bc37071f16d4469bda7e47eb2641c843fa60359eaac9ef;
}
...
// name: Lossy Compressed Texture Samples
// description: Number of lossy compressed texture samples
// type: Count
function LossyCompressedSamples()
{
    return _4e06778c6dbd312e12fd320be6a28037bd94e2cc19c8687aba8981ec52f7d19e * 4;
}
...
// name: Lossy Compressed Samples %
// description: Percentage of samples to lossy compressed textures
// type: Percentage
function LossyCompressedSamplesPercent()
{
    return Math.min((LossyCompressedSamples() * 100.0) / Math.max(TextureSamples(), 1.0), 100.0);
}
...
{
    return Math.max(TextureSamples() - (CompressedSamples() + LosslessCompressedSamples() + LossyCompressedSamples()), 0);
}
...
// name: Lossy Compressed Pixels Written to Memory
// description: Number of lossy compressed pixels written to memory
// type: Count
function LossyCompressedPixelsWrittenToMemory()
{
    return (_0dd4e0e84cea58e9d2d29544bac872bcdc0701ecaceac915d3c6de18a4ee1ca1 + _a84e3546fb8fc80b1b00d5f99647ee97b02bba2df0bf8de22bec1f68f60617d2 + _8d5a521d539fb52b23a297966c80ed6029883735546665130bb173e9f533be68) * 4;
}

// name: Total SB for Lossy Compression
// description: Number of SB for Lossy Compression
// type: Count
function TotalSBUsedInLossyCompression()
{
    return (_5139262f4aa51a2a266c84eae7b1d2a0524e10ec154ddf35e1e1bc529071258a + _a126f888ccf5d17092b398420351fb81f0c5462f5e15a2bf22f6914208f68de2 + _b2f6334df9fdac01bda9fa44b127edadeb640750d6824c0b27a248d10aba3638 + _346c9e2c1dd65c22e4dcdd48f80c681551c075280b02796f700601c4530e6f4f + _ba686a2bead0a853932fbb1feeb87f6b3cabbfa17f2e647b7d6f92105f398c4d + _5d5cf41f6d7d32235e797b13857ad1e9dfa3b04d83470ee5997d55d83e8107aa);
}

// name: Percentage lossless compressed SB
// description: Number of lossless compressed SB, indicates possible B/W saving
// type: Percentage
function PercentageLosslessCompressedSB()
{
    return Math.min((100.0 * _5139262f4aa51a2a266c84eae7b1d2a0524e10ec154ddf35e1e1bc529071258a) / Math.max(TotalSBUsedInLossyCompression(), 1.0), 100.0);
}

// name: Percentage lossy compressed SB no FB
// description: Number of lossy compressed SB no FB. Generally no B/W saving
// type: Percentage
function PercentageLossyCompressedSBNoFB()
{
    return Math.min((100.0 * _a126f888ccf5d17092b398420351fb81f0c5462f5e15a2bf22f6914208f68de2) / Math.max(TotalSBUsedInLossyCompression(), 1.0), 100.0);
}

// name: Percentage lossy compressed SB with FB
// description: Number of lossy compressed SB with FB. Generally no B/W saving
// type: Percentage
function PercentageLossyCompressedSBWithFB()
{
    return Math.min((100.0 * (_b2f6334df9fdac01bda9fa44b127edadeb640750d6824c0b27a248d10aba3638 + _346c9e2c1dd65c22e4dcdd48f80c681551c075280b02796f700601c4530e6f4f + _ba686a2bead0a853932fbb1feeb87f6b3cabbfa17f2e647b7d6f92105f398c4d + _5d5cf41f6d7d32235e797b13857ad1e9dfa3b04d83470ee5997d55d83e8107aa)) / Math.max(TotalSBUsedInLossyCompression(), 1.0), 100.0);
}

// name: Average lossy compressed FB Regions for lossy compressed SB
// description: Average number of lossy compressed FB regions for lossy compressed SB
// type: Rate
function AverageFBRegionsLossyCompressedSBs()
{
    return (_b2f6334df9fdac01bda9fa44b127edadeb640750d6824c0b27a248d10aba3638 + 2*_346c9e2c1dd65c22e4dcdd48f80c681551c075280b02796f700601c4530e6f4f + 3*_ba686a2bead0a853932fbb1feeb87f6b3cabbfa17f2e647b7d6f92105f398c4d + 4*_5d5cf41f6d7d32235e797b13857ad1e9dfa3b04d83470ee5997d55d83e8107aa) / 
           Math.max((_a126f888ccf5d17092b398420351fb81f0c5462f5e15a2bf22f6914208f68de2 + _b2f6334df9fdac01bda9fa44b127edadeb640750d6824c0b27a248d10aba3638 + _346c9e2c1dd65c22e4dcdd48f80c681551c075280b02796f700601c4530e6f4f + _ba686a2bead0a853932fbb1feeb87f6b3cabbfa17f2e647b7d6f92105f398c4d + _5d5cf41f6d7d32235e797b13857ad1e9dfa3b04d83470ee5997d55d83e8107aa), 1.0);
}
...
// name: Thread Group Atomic Bytes Read and Written
...
// name: Lossless Compressed Texture Bytes Read from TC
// description: Number of lossless compresed texture bytes from TC
// type: Count
function LosslessCompressedBytesFromTC()
{
    return _3a25f8b9b9a3bb6fee419881039de7947be1fc155061f0ed642d5957df2c9221 * 64;
}

// name: Uncompressed Texture Bytes Read from TC
// description: Number of uncompressed texture bytes from TC
// type: Count
function UncompressedBytesFromTC()
{
    return _732f9ae18abcb107b504911ba9abe0422500b581734d0a11f801be57da3a56b5 * 64;
}

// name: Lossy Compressed Texture Bytes Read from TC
// description: Number of lossy compressed texture bytes from TC
// type: Count
function LossyCompressedBytesFromTC()
{
    return (_ba0f7bef8431f94f98ea8587e522d4c8468e2bab9bc0be87d3b8b9ac97981db3 + _48d6a3135170e202f4c373f10c7fe2f4f35ae24a0feecef8accedc4f75fb7af4 + _01d049a728cff3c54b425c2839925c3f72de7d5110d2cd0b6823d0360fd8b0d4) * 64;
}
...
{
    return (_5c5c55d05fb355aa5be61ac63c88eb4a2a521a47dd8f79c18b5c1df163d5cb55_norm + _c9bcd5df6397dc8477a12ddf9358bccbbb3d8e52fc3dadab320be9bbb14fe157_norm) / 8.0;
}
...
{    
    return _5c5c55d05fb355aa5be61ac63c88eb4a2a521a47dd8f79c18b5c1df163d5cb55_norm / 8.0;
}
