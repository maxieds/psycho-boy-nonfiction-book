    ...
    content = {
        ...
        variables = {
         ...
         -- TEXMFCACHE      = "$SELFAUTOPARENT/texmf-cache",
            ...
            TEXMFSYSVAR     = "/opt/local/var/db/texmf",
            ...
            TEXMFOS         = "/opt/local/libexec/texlive/binaries",
            TEXMFDIST       = "/opt/local/share/texmf-texlive",

            TEXMFLOCAL      = "/opt/local/share/texmf-local",
            TEXMFPORTS      = "/opt/local/share/texmf",
            TEXMFSYSCONFIG  = "/opt/local/etc/texmf",
            TEXMFFONTS      = "/opt/local/share/texmf-fonts",
            TEXMFPROJECT    = "/opt/local/share/texmf-project",
            ...
            CLUAINPUTS      = ".;/opt/local/lib/$engine//",
