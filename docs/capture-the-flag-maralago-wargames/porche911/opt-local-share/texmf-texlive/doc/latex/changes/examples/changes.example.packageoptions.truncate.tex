%%
%% This is file `examples/changes.example.packageoptions.truncate.tex',
...
\verb|\usepackage[truncate=hyphenate]{changes}|
...
%%
%% End of file `examples/changes.example.packageoptions.truncate.tex'.
