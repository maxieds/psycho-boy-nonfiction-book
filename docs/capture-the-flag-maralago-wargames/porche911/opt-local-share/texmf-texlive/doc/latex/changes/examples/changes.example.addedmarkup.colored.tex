%%
%% This is file `examples/changes.example.addedmarkup.colored.tex',
...
\verb|\usepackage[addedmarkup=colored]{changes}|
...
%%
%% End of file `examples/changes.example.addedmarkup.colored.tex'.
