%%
%% This is file `examples/changes.example.package.hyperref.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:package.hyperref')
%% 
%% changes.dtx
...
\verb|\usepackage{hyperref}| for linked list of changes
...
%%
%% End of file `examples/changes.example.package.hyperref.tex'.
