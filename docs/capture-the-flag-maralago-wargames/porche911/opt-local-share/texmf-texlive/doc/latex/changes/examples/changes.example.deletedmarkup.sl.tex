%%
%% This is file `examples/changes.example.deletedmarkup.sl.tex',
...
\verb|\usepackage[deletedmarkup=sl]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.sl.tex'.
