%%
%% This is file `examples/changes.example.authormarkup.superscript.tex',
...
\verb|\usepackage[authormarkup=superscript]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkup.superscript.tex'.
