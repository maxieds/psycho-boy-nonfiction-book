%%
%% This is file `examples/changes.example.deletedmarkup.bf.tex',
...
\verb|\usepackage[deletedmarkup=bf]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.bf.tex'.
