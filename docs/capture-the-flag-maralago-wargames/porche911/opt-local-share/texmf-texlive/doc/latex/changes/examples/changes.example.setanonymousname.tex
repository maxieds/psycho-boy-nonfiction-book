%%
%% This is file `examples/changes.example.setanonymousname.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:setanonymousname')
%% 
%% changes.dtx
...
\verb|\usepackage[authormarkuptext=name]{changes} \setanonymousname{Not so anonymous}|
...
%%
%% End of file `examples/changes.example.setanonymousname.tex'.
