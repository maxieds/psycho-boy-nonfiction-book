%%
%% This is file `examples/changes.example.packageoptions.xcolor.tex',
...
\verb|\usepackage[xcolor=hideerrors]{changes}|
...
%%
%% End of file `examples/changes.example.packageoptions.xcolor.tex'.
