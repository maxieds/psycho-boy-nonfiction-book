%%
%% This is file `regression/changes.regression.final.nobabel.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% regression.dtx  (with options: `regression:final:nobabel')
%% 
%% changes.dtx
...
%%
%% End of file `regression/changes.regression.final.nobabel.tex'.
