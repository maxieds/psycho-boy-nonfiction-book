%%
%% This is file `examples/changes.example.authormarkuptext.id.tex',
...
\verb|\usepackage[authormarkuptext=id]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkuptext.id.tex'.
