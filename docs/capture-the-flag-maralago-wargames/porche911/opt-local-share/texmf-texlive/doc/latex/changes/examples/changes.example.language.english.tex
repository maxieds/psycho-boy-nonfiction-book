%%
%% This is file `examples/changes.example.language.english.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:language:english')
%% 
%% changes.dtx
...
\verb|\documentclass[11pt, a4paper, notitlepage, english]{article}|
...
%%
%% End of file `examples/changes.example.language.english.tex'.
