%%
%% This is file `examples/changes.example.authormarkup.brackets.tex',
...
\verb|\usepackage[authormarkup=brackets]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkup.brackets.tex'.
