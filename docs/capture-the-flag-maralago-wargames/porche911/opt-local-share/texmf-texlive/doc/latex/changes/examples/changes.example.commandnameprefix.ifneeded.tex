%%
%% This is file `examples/changes.example.commandnameprefix.ifneeded.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:commandnameprefix:ifneeded')
%% 
%% changes.dtx
...
\verb|\usepackage[commandnameprefix=ifneeded]{changes}|
...
%%
%% End of file `examples/changes.example.commandnameprefix.ifneeded.tex'.
