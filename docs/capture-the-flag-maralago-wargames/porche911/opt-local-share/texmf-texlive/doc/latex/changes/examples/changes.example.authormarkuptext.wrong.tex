%%
%% This is file `examples/changes.example.authormarkuptext.wrong.tex',
...
\verb|\usepackage[authormarkuptext=wrong]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkuptext.wrong.tex'.
