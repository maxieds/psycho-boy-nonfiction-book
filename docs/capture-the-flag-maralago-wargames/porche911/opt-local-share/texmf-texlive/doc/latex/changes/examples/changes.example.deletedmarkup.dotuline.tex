%%
%% This is file `examples/changes.example.deletedmarkup.dotuline.tex',
...
\verb|\usepackage[deletedmarkup=dotuline]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.dotuline.tex'.
