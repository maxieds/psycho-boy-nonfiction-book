%%
%% This is file `examples/changes.example.markup.underlined.tex',
...
\verb|\usepackage[markup=underlined]{changes}|
...
%%
%% End of file `examples/changes.example.markup.underlined.tex'.
