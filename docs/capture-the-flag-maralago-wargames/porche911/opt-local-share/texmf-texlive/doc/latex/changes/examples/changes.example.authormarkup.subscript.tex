%%
%% This is file `examples/changes.example.authormarkup.subscript.tex',
...
\verb|\usepackage[authormarkup=subscript]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkup.subscript.tex'.
