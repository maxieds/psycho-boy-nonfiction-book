%%
%% This is file `examples/changes.example.authormarkup.wrong.tex',
...
\verb|\usepackage[authormarkup=wrong]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkup.wrong.tex'.
