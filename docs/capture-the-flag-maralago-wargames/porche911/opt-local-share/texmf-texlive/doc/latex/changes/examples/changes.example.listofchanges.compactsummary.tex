%%
%% This is file `examples/changes.example.listofchanges.compactsummary.tex',
...
%%
%% End of file `examples/changes.example.listofchanges.compactsummary.tex'.
