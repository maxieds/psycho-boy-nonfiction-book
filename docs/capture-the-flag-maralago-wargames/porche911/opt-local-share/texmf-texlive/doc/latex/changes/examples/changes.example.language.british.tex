%%
%% This is file `examples/changes.example.language.british.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:language:british')
%% 
%% changes.dtx
...
%% 
\documentclass[11pt, a4paper, notitlepage, british]{article}
\usepackage{babel}
\usepackage{changes}
...
\verb|\documentclass[11pt, a4paper, notitlepage, british]{article}|
...
%%
%% End of file `examples/changes.example.language.british.tex'.
