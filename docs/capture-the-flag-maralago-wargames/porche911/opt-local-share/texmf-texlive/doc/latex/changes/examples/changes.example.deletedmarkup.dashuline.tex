%%
%% This is file `examples/changes.example.deletedmarkup.dashuline.tex',
...
\verb|\usepackage[deletedmarkup=dashuline]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.dashuline.tex'.
