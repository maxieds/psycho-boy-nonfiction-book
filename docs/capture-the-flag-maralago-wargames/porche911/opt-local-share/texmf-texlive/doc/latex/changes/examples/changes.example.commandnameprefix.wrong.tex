%%
%% This is file `examples/changes.example.commandnameprefix.wrong.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:commandnameprefix:wrong')
%% 
%% changes.dtx
...
\verb|\usepackage[commandnameprefix=wrong]{changes}|
...
%%
%% End of file `examples/changes.example.commandnameprefix.wrong.tex'.
