%%
%% This is file `examples/changes.example.deletedmarkup.uwave.tex',
...
\verb|\usepackage[deletedmarkup=uwave]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.uwave.tex'.
