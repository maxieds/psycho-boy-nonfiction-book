%%
%% This is file `examples/changes.example.addedmarkup.uline.tex',
...
\verb|\usepackage[addedmarkup=uline]{changes}|
...
%%
%% End of file `examples/changes.example.addedmarkup.uline.tex'.
