%%
%% This is file `examples/changes.example.language.ngerman.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:language:ngerman')
%% 
%% changes.dtx
...
\verb|\documentclass[11pt, a4paper, notitlepage, ngerman]{article}|
...
%%
%% End of file `examples/changes.example.language.ngerman.tex'.
