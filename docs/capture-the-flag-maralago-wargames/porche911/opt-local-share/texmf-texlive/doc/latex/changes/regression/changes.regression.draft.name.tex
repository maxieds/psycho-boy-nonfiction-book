%%
%% This is file `regression/changes.regression.draft.name.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% regression.dtx  (with options: `regression:draft:name')
%% 
%% changes.dtx
...
%%
%% End of file `regression/changes.regression.draft.name.tex'.
