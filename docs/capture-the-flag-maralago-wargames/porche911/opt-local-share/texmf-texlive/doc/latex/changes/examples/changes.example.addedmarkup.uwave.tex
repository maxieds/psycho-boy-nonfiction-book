%%
%% This is file `examples/changes.example.addedmarkup.uwave.tex',
...
\verb|\usepackage[addedmarkup=uwave]{changes}|
...
%%
%% End of file `examples/changes.example.addedmarkup.uwave.tex'.
