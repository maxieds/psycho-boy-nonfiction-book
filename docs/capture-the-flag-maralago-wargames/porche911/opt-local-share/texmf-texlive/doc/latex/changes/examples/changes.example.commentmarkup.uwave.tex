%%
%% This is file `examples/changes.example.commentmarkup.uwave.tex',
...
\verb|\usepackage[commentmarkup=uwave]{changes}|
...
%%
%% End of file `examples/changes.example.commentmarkup.uwave.tex'.
