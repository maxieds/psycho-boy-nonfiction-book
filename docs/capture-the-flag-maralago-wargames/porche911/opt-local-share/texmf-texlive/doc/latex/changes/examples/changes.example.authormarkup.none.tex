%%
%% This is file `examples/changes.example.authormarkup.none.tex',
...
\verb|\usepackage[authormarkup=none]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkup.none.tex'.
