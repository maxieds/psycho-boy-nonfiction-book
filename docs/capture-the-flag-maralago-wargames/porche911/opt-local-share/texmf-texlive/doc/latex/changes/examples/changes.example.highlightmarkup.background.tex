%%
%% This is file `examples/changes.example.highlightmarkup.background.tex',
...
\verb|\usepackage[highlightmarkup=background]{changes}|
...
%%
%% End of file `examples/changes.example.highlightmarkup.background.tex'.
