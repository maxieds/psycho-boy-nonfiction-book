%%
%% This is file `examples/changes.example.addedmarkup.dotuline.tex',
...
\verb|\usepackage[addedmarkup=dotuline]{changes}|
...
%%
%% End of file `examples/changes.example.addedmarkup.dotuline.tex'.
