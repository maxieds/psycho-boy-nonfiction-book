%%
%% This is file `regression/changes.regression.draft.id.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% regression.dtx  (with options: `regression:draft:id')
%% 
%% changes.dtx
...
%%
%% End of file `regression/changes.regression.draft.id.tex'.
