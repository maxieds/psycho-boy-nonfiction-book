%%
%% This is file `examples/changes.example.addedmarkup.dashuline.tex',
...
\verb|\usepackage[addedmarkup=dashuline]{changes}|
...
%%
%% End of file `examples/changes.example.addedmarkup.dashuline.tex'.
