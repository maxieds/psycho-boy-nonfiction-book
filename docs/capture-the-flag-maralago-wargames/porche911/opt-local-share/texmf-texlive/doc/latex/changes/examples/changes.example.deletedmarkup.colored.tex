%%
%% This is file `examples/changes.example.deletedmarkup.colored.tex',
...
\verb|\usepackage[deletedmarkup=colored]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.colored.tex'.
