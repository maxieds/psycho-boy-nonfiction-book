%%
%% This is file `examples/changes.example.deletedmarkup.wrong.tex',
...
\verb|\usepackage[deletedmarkup=wrong]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.wrong.tex'.
