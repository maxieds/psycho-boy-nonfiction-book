%%
%% This is file `examples/changes.example.authormarkup.footnote.tex',
...
\verb|\usepackage[authormarkup=footnote]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkup.footnote.tex'.
