%%
%% This is file `examples/changes.example.authormarkupposition.wrong.tex',
...
\verb|\usepackage[authormarkupposition=wrong]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkupposition.wrong.tex'.
