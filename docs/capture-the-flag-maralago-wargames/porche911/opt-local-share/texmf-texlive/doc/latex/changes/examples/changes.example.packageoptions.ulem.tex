%%
%% This is file `examples/changes.example.packageoptions.ulem.tex',
...
\verb|\usepackage[ulem=UWforbf]{changes}|
...
%%
%% End of file `examples/changes.example.packageoptions.ulem.tex'.
