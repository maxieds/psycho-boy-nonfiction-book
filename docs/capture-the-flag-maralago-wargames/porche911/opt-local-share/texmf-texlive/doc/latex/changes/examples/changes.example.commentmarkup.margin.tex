%%
%% This is file `examples/changes.example.commentmarkup.margin.tex',
...
\verb|\usepackage[commentmarkup=margin]{changes}|
...
%%
%% End of file `examples/changes.example.commentmarkup.margin.tex'.
