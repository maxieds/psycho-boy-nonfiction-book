%%
%% This is file `examples/changes.example.deletedmarkup.uuline.tex',
...
\verb|\usepackage[deletedmarkup=uuline]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.uuline.tex'.
