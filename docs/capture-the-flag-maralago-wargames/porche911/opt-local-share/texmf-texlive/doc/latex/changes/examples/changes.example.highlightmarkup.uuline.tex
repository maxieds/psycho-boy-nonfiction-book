%%
%% This is file `examples/changes.example.highlightmarkup.uuline.tex',
...
\verb|\usepackage[highlightmarkup=uuline]{changes}|
...
%%
%% End of file `examples/changes.example.highlightmarkup.uuline.tex'.
