%%
%% This is file `examples/changes.example.setcommentmarkup.tex',
...
\verb|\setcommentmarkup{\IfIsColored{\color{authorcolor}}{}---~\IfIsAnonymous{#2}{}{\textbf{#3} }#1~---}|
...
%%
%% End of file `examples/changes.example.setcommentmarkup.tex'.
