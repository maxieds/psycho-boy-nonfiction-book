%%
%% This is file `examples/changes.example.deletedmarkup.it.tex',
...
\verb|\usepackage[deletedmarkup=it]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.it.tex'.
