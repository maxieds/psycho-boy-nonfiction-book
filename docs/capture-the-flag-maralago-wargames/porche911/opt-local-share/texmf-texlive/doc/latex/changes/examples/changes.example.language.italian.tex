%%
%% This is file `examples/changes.example.language.italian.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:language:italian')
%% 
%% changes.dtx
...
%% 
\documentclass[11pt, a4paper, notitlepage, italian]{article}
\usepackage{babel}
\usepackage{changes}
...
\verb|\documentclass[11pt, a4paper, notitlepage, italian]{article}|
...
%%
%% End of file `examples/changes.example.language.italian.tex'.
