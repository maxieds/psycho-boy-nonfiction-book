%%
%% This is file `examples/changes.example.commentmarkup.footnote.tex',
...
\verb|\usepackage[commentmarkup=footnote]{changes}|
...
%%
%% End of file `examples/changes.example.commentmarkup.footnote.tex'.
