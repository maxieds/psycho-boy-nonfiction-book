%%
%% This is file `examples/changes.example.highlightmarkup.uwave.tex',
...
\verb|\usepackage[highlightmarkup=uwave]{changes}|
...
%%
%% End of file `examples/changes.example.highlightmarkup.uwave.tex'.
