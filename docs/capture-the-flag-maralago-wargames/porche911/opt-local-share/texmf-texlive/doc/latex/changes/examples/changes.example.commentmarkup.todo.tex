%%
%% This is file `examples/changes.example.commentmarkup.todo.tex',
...
\verb|\usepackage[commentmarkup=todo]{changes}|
...
%%
%% End of file `examples/changes.example.commentmarkup.todo.tex'.
