%%
%% This is file `examples/changes.example.deletedmarkup.xout.tex',
...
\verb|\usepackage[deletedmarkup=xout]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.xout.tex'.
