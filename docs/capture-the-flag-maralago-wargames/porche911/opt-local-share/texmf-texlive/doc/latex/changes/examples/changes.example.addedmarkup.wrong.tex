%%
%% This is file `examples/changes.example.addedmarkup.wrong.tex',
...
\verb|\usepackage[addedmarkup=wrong]{changes}|
...
%%
%% End of file `examples/changes.example.addedmarkup.wrong.tex'.
