%%
%% This is file `examples/changes.example.authormarkupposition.left.tex',
...
\verb|\usepackage[authormarkupposition=left]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkupposition.left.tex'.
