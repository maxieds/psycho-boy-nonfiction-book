%%
%% This is file `examples/changes.example.packageoptions.todonotes.tex',
...
\verb|\usepackage[todonotes={textsize=tiny}]{changes}|
...
%%
%% End of file `examples/changes.example.packageoptions.todonotes.tex'.
