%%
%% This is file `examples/changes.example.language.german.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:language:german')
%% 
%% changes.dtx
...
%% 
\documentclass[11pt, a4paper, notitlepage, german]{article}
\usepackage{babel}
\usepackage{changes}
...
\verb|\documentclass[11pt, a4paper, notitlepage, german]{article}|
...
%%
%% End of file `examples/changes.example.language.german.tex'.
