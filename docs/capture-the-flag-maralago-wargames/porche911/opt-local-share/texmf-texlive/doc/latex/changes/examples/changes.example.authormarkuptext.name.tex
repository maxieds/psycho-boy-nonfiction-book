%%
%% This is file `examples/changes.example.authormarkuptext.name.tex',
...
\verb|\usepackage[authormarkuptext=name]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkuptext.name.tex'.
