%%
%% This is file `examples/changes.example.commandnameprefix.always.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:commandnameprefix:always')
%% 
%% changes.dtx
...
\verb|\usepackage[commandnameprefix=always]{changes}|
...
%%
%% End of file `examples/changes.example.commandnameprefix.always.tex'.
