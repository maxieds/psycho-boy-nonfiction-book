%%
%% This is file `examples/changes.example.commandnameprefix.none.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:commandnameprefix:none')
%% 
%% changes.dtx
...
\verb|\usepackage[commandnameprefix=none]{changes}|
...
%%
%% End of file `examples/changes.example.commandnameprefix.none.tex'.
