%%
%% This is file `examples/changes.example.addedmarkup.uuline.tex',
...
\verb|\usepackage[addedmarkup=uuline]{changes}|
...
%%
%% End of file `examples/changes.example.addedmarkup.uuline.tex'.
