%%
%% This is file `examples/changes.example.commentmarkup.wrong.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:commentmarkup:wrong')
%% 
%% changes.dtx
...
\verb|\usepackage[commentmarkup=wrong]{changes}|
...
%%
%% End of file `examples/changes.example.commentmarkup.wrong.tex'.
