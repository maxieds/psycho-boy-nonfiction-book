%%
%% This is file `examples/changes.example.defaultcolor.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:defaultcolor')
%% 
%% changes.dtx
...
\verb|\usepackage[defaultcolor=magenta]{changes}|
...
%%
%% End of file `examples/changes.example.defaultcolor.tex'.
