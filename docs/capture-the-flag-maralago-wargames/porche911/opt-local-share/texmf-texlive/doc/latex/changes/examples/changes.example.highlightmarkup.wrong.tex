%%
%% This is file `examples/changes.example.highlightmarkup.wrong.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:highlightmarkup:wrong')
%% 
%% changes.dtx
...
\verb|\usepackage[highlightmarkup=wrong]{changes}|
...
%%
%% End of file `examples/changes.example.highlightmarkup.wrong.tex'.
