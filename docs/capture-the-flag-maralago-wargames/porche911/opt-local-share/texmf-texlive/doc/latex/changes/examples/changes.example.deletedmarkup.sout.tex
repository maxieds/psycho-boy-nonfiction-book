%%
%% This is file `examples/changes.example.deletedmarkup.sout.tex',
...
\verb|\usepackage[deletedmarkup=sout]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.sout.tex'.
