%%
%% This is file `examples/changes.example.deletedmarkup.em.tex',
...
\verb|\usepackage[deletedmarkup=em]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.em.tex'.
