%%
%% This is file `regression/changes.regression.draft.nobabel.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% regression.dtx  (with options: `regression:draft:nobabel')
%% 
%% changes.dtx
...
%%
%% End of file `regression/changes.regression.draft.nobabel.tex'.
