%%
%% This is file `examples/changes.example.deletedmarkup.uline.tex',
...
\verb|\usepackage[deletedmarkup=uline]{changes}|
...
%%
%% End of file `examples/changes.example.deletedmarkup.uline.tex'.
