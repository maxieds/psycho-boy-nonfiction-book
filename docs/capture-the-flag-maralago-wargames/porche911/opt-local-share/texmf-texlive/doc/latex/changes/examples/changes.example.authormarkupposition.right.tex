%%
%% This is file `examples/changes.example.authormarkupposition.right.tex',
...
\verb|\usepackage[authormarkupposition=right]{changes}|
...
%%
%% End of file `examples/changes.example.authormarkupposition.right.tex'.
