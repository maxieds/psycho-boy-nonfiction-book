%%
%% This is file `examples/changes.example.language.french.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:language:french')
%% 
%% changes.dtx
...
%% 
\documentclass[11pt, a4paper, notitlepage, french]{article}
\usepackage{babel}
\usepackage{changes}
...
\verb|\documentclass[11pt, a4paper, notitlepage, french]{article}|
...
%%
%% End of file `examples/changes.example.language.french.tex'.
