%%
%% This is file `factura-ejemplo-cotizacion.tex',
...
% \Denominacion{PRESUPUESTO} % También podemos cambiar el nombre del documento.
...
%% 
%%
%% End of file `factura-ejemplo-cotizacion.tex'.
