...
pdfsubject = {LSE - emission lines of the elements},%
pdfkeywords = {Data get from: http://cdsarc.u-strasbg.fr/viz-bin/Cat?VI/16^^JLSE - «Line Spectra of the Elements», Joseph Reader and Charles H. Corliss CRC Handbook of Chemistry and Physics, 96th Edition},%
...
\fancypagestyle{wlLSE}{%
\fancyhf{} % clear all header and footer fields
\fancyhead[R]{Lines Data (LSE)}%
