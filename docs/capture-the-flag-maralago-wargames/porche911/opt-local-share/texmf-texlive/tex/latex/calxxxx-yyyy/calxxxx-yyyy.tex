...
\ProvidesFile{calxxxx-yyyy.tex}%
  [2025/01/01 v20.25a Print a calendar for a group of years (HMM)]
%
% Copyright © 2010 - 2025 H.-Martin Münch (Martin dot Muench at Uni-Bonn dot de)
...
%   calxxxx-yyyy-doc.pdf, cal2025-2042_DE.pdf, cal2025-2042_DK.pdf,
%   and cal2025-2042_EN.pdf.
%
% In memoriam
...
%
\documentclass[12pt,a4paper,danish,german,english]{report}[2024/06/29]% v1.4n
% In the options you need to place the desired language at the last position.
% Sorry for the inconvenience.
\usepackage{babel}[2024/12/21]% v24.15
...
\usepackage{array}[2024/10/17]% v2.6g
\listfiles
\thispagestyle{empty}
...
these calendars produced with calxxxx-yyyy 2025-01-01 v20.25a by \texttt{Martin.Muench@Uni-Bonn.de};%
\newline\indent%
